This repository includes tools to analyze delta B contributions to the earth's total magnetic field.  In the initial version, it is examining the div_simple1 data.  The two major components are:
