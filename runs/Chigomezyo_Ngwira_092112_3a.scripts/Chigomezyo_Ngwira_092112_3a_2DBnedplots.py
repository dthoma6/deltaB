...
if __name__ == "__main__":
    ...
    db.loop_ms_b(info, point, reduce, deltahr=deltahr)    
    db.loop_gap_b(info, point, reduce, nR=100, deltahr=deltahr, useRIM=True)
    db.loop_iono_b(info, point, reduce, deltahr=deltahr)
